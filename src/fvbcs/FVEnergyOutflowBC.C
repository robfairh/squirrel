...
#include "FVEnergyOutflowBC.h"

registerADMooseObject("SquirrelApp", FVEnergyOutflowBC);

InputParameters
FVEnergyOutflowBC::validParams()
{
...
FVEnergyOutflowBC::FVEnergyOutflowBC(const InputParameters & params)
  : FVFluxBC(params),
...
ADReal
FVEnergyOutflowBC::computeQpResidual()
{
  return _normal * _vel[_qp] * (*_adv_quant)[_qp] + _normal * _vel[_qp] * _p[_qp];
}
