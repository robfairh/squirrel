...
#include "MatFVTemperatureOutflowBC.h"

registerADMooseObject("SquirrelApp", MatFVTemperatureOutflowBC);

InputParameters
MatFVTemperatureOutflowBC::validParams()
{
...
MatFVTemperatureOutflowBC::MatFVTemperatureOutflowBC(const InputParameters & params)
  : FVFluxBC(params),
...
ADReal
MatFVTemperatureOutflowBC::computeQpResidual()
{
  return _cp * _normal * _vel[_qp] * (*_adv_quant)[_qp];
}
