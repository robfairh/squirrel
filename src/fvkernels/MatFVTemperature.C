...
#include "MatFVTemperature.h"

registerADMooseObject("SquirrelApp", MatFVTemperature);

InputParameters
MatFVTemperature::validParams()
{
...
MatFVTemperature::MatFVTemperature(const InputParameters & params)
  : FVFluxKernel(params),
...
ADReal
MatFVTemperature::computeQpResidual()
{
  ADRealVectorValue v;
  ADReal u_interface;
  ...
  return _cp * _normal * v * u_interface;
}
