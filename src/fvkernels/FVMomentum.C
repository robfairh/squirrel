...
#include "FVMomentum.h"

registerADMooseObject("MooseApp", FVMomentum);

InputParameters
FVMomentum::validParams()
{
...
FVMomentum::FVMomentum(const InputParameters & params)
  : FVFluxKernel(params),
